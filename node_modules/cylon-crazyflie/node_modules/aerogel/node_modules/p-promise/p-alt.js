...
;(function( factory ){
	...
	function queueTask( task, a, b, domain, trace ) {
		var node = tail.next;
	...
	function ReportIfRejected( p ) {
		if ( p._state === REJECTED ) {
			queueTask( reportError, p._value, null, p._domain, null );
		}
	}
